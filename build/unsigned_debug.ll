...
if_merge10:                                       ; preds = %if_merge6
  ...
  %sdiv = sdiv i32 %big11, 2
  store i32 %sdiv, ptr %ld, align 4
...
if_merge15:                                       ; preds = %if_merge10
  ...
  %sdiv17 = sdiv i32 %gvar_a, %gvar_b
  store i32 %sdiv17, ptr %gd, align 4
  %gd18 = load i32, ptr %gd, align 4
  %icmp19 = icmp ne i32 %gd18, 1073741824
  br i1 %icmp19, label %if_then20, label %if_merge21

if_then20:                                        ; preds = %if_merge15
  ret i32 5

if_merge21:                                       ; preds = %if_merge15
  %z = alloca i32, align 4
  %big22 = load i32, ptr %big, align 4
  %sdiv23 = sdiv i32 %big22, 2
  %mul = mul i32 %sdiv23, 2
  store i32 %mul, ptr %z, align 4
  %z24 = load i32, ptr %z, align 4
  %icmp25 = icmp ne i32 %z24, -2147483648
  br i1 %icmp25, label %if_then26, label %if_merge27

if_then26:                                        ; preds = %if_merge21
  ret i32 6

if_merge27:                                       ; preds = %if_merge21
  ret i32 0
}
