...
@include <compiler/diagnostics.arc>
@include <compiler/analysis/scope.arc>
@include <compiler/analysis/types.arc>
@include <compiler/analysis/main.arc>
@include <compiler/ir/context.arc>
@include <compiler/ir/types.arc>
@include <compiler/ir/names.arc>
@include <compiler/ir/exprs.arc>
@include <compiler/ir/stmts.arc>
@include <compiler/ir/decls.arc>
@include <compiler/ir/main.arc>
