; ModuleID = '.tmpwork/z2.arc'
source_filename = ".tmpwork/z2.arc"
...
entry:
  ...
  store [5 x ptr] zeroinitializer, ptr %arr, align 8
  %n = alloca i32, align 4
  store i32 0, ptr %n, align 4
  %p = alloca ptr, align 8
  store ptr null, ptr %p, align 8
  %n1 = load i32, ptr %n, align 4
  %arr_gep = getelementptr [5 x ptr], ptr %arr, i64 0, i32 0
  %idx_load = load ptr, ptr %arr_gep, align 8
  %p2i = ptrtoint ptr %idx_load to i64
  %trunc = trunc i64 %p2i to i32
  %add = add i32 %n1, %trunc
  %p2 = load ptr, ptr %p, align 8
  %p2i3 = ptrtoint ptr %p2 to i64
  %trunc4 = trunc i64 %p2i3 to i32
  %add5 = add i32 %add, %trunc4
  ret i32 %add5
}
