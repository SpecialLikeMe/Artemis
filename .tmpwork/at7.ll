; ModuleID = '.tmpwork/at7.arc'
source_filename = ".tmpwork/at7.arc"
target datalayout = "e-m:w-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-w64-windows-gnu"

%memstr = type { ptr, ptr }
%__vtable__ = type { ptr, ptr, ptr, ptr, ptr }
%__anon_313 = type { ptr, i32 }
...
@str.1 = private unnamed_addr constant [7 x i8] c"sz=%d\0A\00", align 1
...
entry:
  ...
  %anon_s = alloca %__anon_313, align 8
  %anon_f = getelementptr inbounds nuw %__anon_313, ptr %anon_s, i32 0, i32 0
  store ptr @str, ptr %anon_f, align 8
  %anon_f2 = getelementptr inbounds nuw %__anon_313, ptr %anon_s, i32 0, i32 1
  store i32 %n1, ptr %anon_f2, align 4
  %anon_load = load %__anon_313, ptr %anon_s, align 8
  %0 = call i32 @shape__at_args_struct(%__anon_313 %anon_load)
  store i32 %0, ptr %a, align 4
  %a3 = load i32, ptr %a, align 4
  %1 = call i32 (ptr, ...) @printf(ptr @str.1, i32 %a3)
  ret i32 0
}

define internal i32 @shape__at_args_struct(%__anon_313 %0) {
entry:
  %args = alloca %__anon_313, align 8
  store %__anon_313 %0, ptr %args, align 8
  %args1 = load %__anon_313, ptr %args, align 8
  ret i32 ptrtoint (ptr getelementptr (i64, ptr null, i32 1) to i32)
}
