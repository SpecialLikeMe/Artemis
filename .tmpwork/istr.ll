; ModuleID = '.tmpwork/istr.arc'
source_filename = ".tmpwork/istr.arc"
...
@str.2 = private unnamed_addr constant [18 x i8] c"error at line %d\0A\00", align 1
...
define internal void @box_t__NS_boom(ptr %0) {
entry:
  %self = alloca ptr, align 8
  store ptr %0, ptr %self, align 8
  %start_line = alloca i32, align 4
  %ptr_deref = load ptr, ptr %self, align 8
  %line = getelementptr inbounds nuw %box_t, ptr %ptr_deref, i32 0, i32 0
  %ptr_deref1 = load ptr, ptr %self, align 8
  %mem_load = load i32, ptr %line, align 4
  store i32 %mem_load, ptr %start_line, align 4
  %start_line2 = load i32, ptr %start_line, align 4
  %anon_s = alloca %__anon1_i32, align 8
  %anon_f = getelementptr inbounds nuw %__anon1_i32, ptr %anon_s, i32 0, i32 0
  store i32 %start_line2, ptr %anon_f, align 4
  %anon_load = load %__anon1_i32, ptr %anon_s, align 4
  %1 = call i32 @aprint__at_args_S__anon1_i32(ptr @str.2, %__anon1_i32 %anon_load)
  ret void
}

define internal i32 @aprint__at_args_S__anon1_i32(ptr %0, %__anon1_i32 %1) {
entry:
  %fmt = alloca ptr, align 8
...
if_then31:                                        ; preds = %if_merge
  ...
  %3 = call ptr @stdout_file()
  %4 = call i64 @fwrite.1(ptr %arr_decay33, i64 1, i64 %zext35, ptr %3)
...
if_merge32:                                       ; preds = %if_merge
  ...
  %5 = call ptr @arc_malloc(i64 %need39)
...
if_then42:                                        ; preds = %if_merge32
  ...
  %6 = call ptr @stdout_file()
  %7 = call i64 @fwrite.1(ptr %arr_decay44, i64 1, i64 4095, ptr %6)
...
if_merge43:                                       ; preds = %if_merge32
  ...
  %9 = call ptr @stdout_file()
  %10 = call i64 @fwrite.1(ptr %hbuf52, i64 1, i64 %zext54, ptr %9)
  %hbuf55 = load ptr, ptr %hbuf, align 8
  call void @arc_free(ptr %hbuf55)
...
define i32 @main() {
entry:
  %b = alloca %box_t, align 8
  store %box_t zeroinitializer, ptr %b, align 4
  %line = getelementptr inbounds nuw %box_t, ptr %b, i32 0, i32 0
  store i32 3, ptr %line, align 4
  call void @box_t__NS_boom(ptr %b)
  ret i32 0
}
