...
//
//   @cstype(expr)        — returns first-class type value for use with `type` variables
//                          expr kind: ek_cstype      (ir/exprs.arc) [TODO]
//
...
void builtin_init() {
    ...
    g_builtins[4].name = "cstype";   g_builtins[4].kind = 30; // ek_cstype (future)
    g_builtins_len = 5;
}

bool is_builtin(i8* name) {
