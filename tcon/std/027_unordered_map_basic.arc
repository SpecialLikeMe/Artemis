// Test: std.unordered_map — hash map with i32 keys/values
...
pub fn main() i32 {
    ...
    let mut m: std.unordered_map<i32,i32>(16, a);
    ...
    if (v10b == (i32*)0 || *v10b != 999) { return 6; }

    // Remove
    m.remove(5);
    if (m.contains(5))   { return 7; }
    if (m.size() != 3)   { return 8; }

    if (m.is_empty())    { return 9; }
